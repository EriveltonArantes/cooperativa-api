...
|----------|---------|---------|
| `/api/cooperados` | GET / POST / PUT / DELETE | CRUD de Cooperado |
| `/api/produtos` | GET / POST / PUT / DELETE | CRUD de Produto |
| `/api/entregaprodutos` | GET / POST / PUT / DELETE | CRUD de EntregaProduto |
| `/api/dividendos` | GET / POST / PUT / DELETE | CRUD de Dividendo |
